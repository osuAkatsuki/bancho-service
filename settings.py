...
LOG_CONCURRENCY_REPORTS = read_bool(os.environ["LOG_CONCURRENCY_REPORTS"])

AUDIT_LOG_MESSAGE_KEYWORDS = os.environ["AUDIT_LOG_MESSAGE_KEYWORDS"].split(",")
SHOULD_ENFORCE_SINGLE_ACCOUNT_POLICY = read_bool(
    os.environ["SHOULD_ENFORCE_SINGLE_ACCOUNT_POLICY"],
)

LOCALIZE_ENABLE = read_bool(os.environ["LOCALIZE_ENABLE"])
